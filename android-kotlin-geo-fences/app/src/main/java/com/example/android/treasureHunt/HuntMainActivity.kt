 ...
 */
    ...
    private fun addGeofenceForClue() {
        ...
        val currentData = GeofencingConstants.LANDMARK_DATA[currentGeofenceIndex]

        val geofence = Geofence.Builder()
            .setRequestId(currentData.id)
            .setCircularRegion(currentData.latLong.latitude, currentData.latLong.longitude, GeofencingConstants.GEOFENCE_RADIUS_IN_METERS)

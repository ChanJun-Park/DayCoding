package com.jingom.myclippingexample
...
class ClippedView @JvmOverloads constructor(
	...
	private val textString = context.getString(R.string.clipping)
	...
	private fun drawClippedRectangle(canvas: Canvas) {
		...
		canvas.drawText(textString, clipRectRight, textOffset, paint)
	}
	...
	private fun drawCombinedClippingExample(canvas: Canvas) {
		...
		path.addRect(
			...
			clipRectRight / 2 + circleRadius,
			clipRectBottom - rectInset, Path.Direction.CW
		)
...
// Apply skew transformation.
	...
	private fun drawQuickRejectExample(canvas: Canvas) {
		...
		val isRejected = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
